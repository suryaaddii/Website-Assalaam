            ...
            <aside
                ...
                <div class="flex flex-col h-full">
                    ...
                    <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
                        <a href="/"><img src="{{ asset('images/logoTeks.png') }}" alt="logo" class='w-36' />
                        </a>
                        ...
                        <div x-data="{ isActive: false, open: false }">
                            ...
                            <a href="#" @click="$event.preventDefault(); open = !open"
                                ...
                                <span class="ml-2 text-sm"> Akun </span>
                        ...
                        <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                            ...
                            <div class="relative ml-auto" x-data="{ open: false }">
                                <button @click="open = !open" type="button" aria-haspopup="true"
                                    ...
                                    <img class="w-10 h-10 rounded-full" src="build/images/surya.jpg"
                                        alt="Surya Adi" />
                                </button>
                ...
                <main>
                    ...
                    <div class="mt-2">
                        ...
                        <div class="grid grid-cols-1 gap-8 p-4 lg:grid-cols-3 ">
                            <!-- Value card -->
                            <div
                                class="flex items-center justify-between p-4 bg-white rounded-md dark:bg-darker w-full max-w-sm">
                                <div>
                                    <h6
                                        class="text-xs font-medium leading-none tracking-wider text-gray-500 uppercase dark:text-primary-light">
                                        TOTAL BELANJA
                                    </h6>
                                    <span class="text-xl font-semibold">Rp 150.000,00</span>
                                    <span
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <span class="text-xl font-semibold">AKTIF</span>
                                </div>
                                <div>
                                    <span>
                                        <svg class="w-12 h-12 text-gray-300 dark:text-primary-dark"
                        ...
                        <div class="grid grid-cols-1 p-4 space-y-8 lg:gap-8 lg:space-y-0 lg:grid-cols-3">
                            ...
                            <div class="col-span-2 bg-white rounded-md dark:bg-darker" x-data="{ isOn: false }">
                                ...
                                <div class="flex items-center justify-between p-4 border-b dark:border-primary">
                                    <h4 class="text-lg font-semibold text-gray-500 dark:text-light">Riwayat Belanja
                                    </h4>
                        ...
                        <div class="space-y-4" x-show.transition.in="activeTabe == 'user'">
                            <a href="#" class="block">
                                <div class="flex px-4 space-x-4">
                                    <div class="relative flex-shrink-0">
                                        <span class="relative z-10 inline-block overflow-visible rounded-ful">
                                            <img class="object-cover rounded-full w-9 h-9"
                                                src="build/images/surya.jpg" alt="Surya Adi" />
                                        </span>
                                        <div
                                            class="absolute h-24 p-px -mt-3 -ml-px bg-primary-50 left-1/2 dark:bg-primary-darker">
                                        </div>
                                    ...
                                    <div class="flex-1 overflow-hidden">
                                        <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Surya Adi
                                        </h5>
                                        <p
                                            class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                ...
                <div class="flex flex-col h-screen">
                    ...
                    <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden h hover:overflow-y-auto">
                        ...
                        <a href="#" class="flex space-x-4">
                            <div class="flex-shrink-0">
                                <img class="w-10 h-10 rounded-lg" src="build/images/surya.jpg" alt="Post cover" />
                            </div>
                        ...
                        <a href="#" class="flex space-x-4">
                            <div class="flex-shrink-0">
                                <img class="w-10 h-10 rounded-lg" src="build/images/surya.jpg" alt="Surya Adi" />
                            </div>
                            <div class="flex-1 max-w-xs overflow-hidden">
                                <h4 class="text-sm font-semibold text-gray-600 dark:text-light">Surya Adi</h4>
                                <p class="text-sm font-normal text-gray-400 truncate dark:text-primary-lighter">
                        ...
                        <a href="#" class="flex space-x-4">
                            <div class="flex-shrink-0">
                                <img class="w-10 h-10 rounded-lg" src="build/images/surya.jpg"
                                    alt="K-WD Dashboard" />
                            </div>
                            <div class="flex-1 max-w-xs overflow-hidden">
