...
<head>
    ...
    <title>Membership Assalaam Hypermarket</title>
</head>
            ...
            <div id="membership" class="px-4 sm:px-10">
                <div class="max-w-7xl mx-auto">
                    <div class="mb-0 max-w-2xl text-center mx-auto">
                        <h2 class="text-lg text-green-800 font-semibold flex-1 text text-center pt-12">K A R T U M E M B
                            E R
                        </h2>
                    </div>
                    <div>
                        <div
                            class="w-fit-center px-3 py-4 mt-10 bg-white rounded-xl shadow-md transform hover:scale-105 transition-transform duration-300 ease-in-out mx-7 mb-20">
