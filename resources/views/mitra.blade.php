...
<head>
    ...
    <title>Mitra Assalaam Hypermarket</title>
</head>

<body class="max-w-[1920px] max-h-[1080px] mx-auto">
    <div class="bg-gray-200 text-gray-100 text-[15px] mb">
        ...
        <section class="min-h-screen bg-contain bg-center bg-repeat"
            ...
            {{-- HALAMAN MITRA --}}
            <div id="mitra" class="px-4 sm:px-10">
                <div class="mt-1 max-w-7xl mx-auto">
                    <div class="mb-0 max-w-2xl text-center mx-auto">
                        <h2 class="text-lg text-green-800 font-semibold flex-1 text text-center mt-12">K E R J A S A M A
                        </h2>
                    </div>
                    <div>
                        <div
                            class="w-fit-center px-3 py-4 mt-12 bg-white rounded-xl shadow-md transform hover:scale-105 transition-transform duration-300 ease-in-out mx-7">
                            <h2 class="text-sm  font-bold text-slate-950 text-center">T E N A N T</h2>
                            <img src="{{ asset('images/tenant.jpeg') }}" class="my-6 w-50 mx-auto" />
                            <div class="p-4">
                                <p class="text-sm text-slate-950 leading-relaxed text-justify"> Assalaam Hypermarket
                                    sudah
                                    menjalin
                                    dengan lebih dari 100 tenan yang bekerjasama dan maju bersama kami. Mari bergabung
                                    dengan
                                    Assalaam Hypermarket untuk memperluas usaha anda. </p>
                                <p class="text-sm text-slate-950 leading-relaxed text-justify font-bold mt-6"> Contact
                                    Person
                                    Marketing : </p>
                                <p class="text-sm text-green-600 leading-relaxed text-justify font-bold "> Admin
                                    Marketing I
                                    (085742148860) </p>
                                <p class="text-sm text-green-600 leading-relaxed text-justify font-bold "> Admin
                                    Marketing
                        ...
                        <div
                            class="w-fit-center px-3 py-4 mt-10 bg-white rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300 ease-in-out mx-7">
                            <h2 class="text-sm  font-bold text-slate-950 text-center">M E R C H A N D I S I N G</h2>
                            <img src="{{ asset('images/merchandising.jpg') }}" class="my-6 w-50 mx-auto" />
                            <div class="p-4">
                                <p class="text-sm text-slate-950 leading-relaxed text-justify">Mari bergabung bersama
                                    Assalaam
                                    Hypermarket dalam menjadi mitra produk untuk Assalaam Hypermarket. </p>
                                <p class="text-sm text-slate-950 leading-relaxed text-justify font-bold mt-6"> Contact
                                    Person
                                    Merchandising: </p>
                                <p class="text-sm text-green-600 leading-relaxed text-justify font-bold "> Admin
                        ...
                        <div
                            class="w-fit-center px-3 py-4 mt-10 bg-white rounded-lg shadow-md transform hover:scale-105 transition-transform duration-300 ease-in-out mx-7">
                            <h2 class="text-sm  font-bold text-slate-950 text-center">K U L A K A N</h2>
                            <img src="{{ asset('images/kulakan.jpeg') }}" class="my-6 w-50 mx-auto" />
                            <div class="p-4">
                                <p class="text-sm text-slate-950 leading-relaxed text-justify">Bagi anda yang berencana
                                    membuka
                                    usaha toko atau mini market ataupun baru mencari kebutuhan toko dengan harga barang
                                    yg
                                    terbaik
                                    dengan harga grosir/kulakan, silahkan menghubungi kami.</p>
                                <p class="text-sm text-slate-950 leading-relaxed text-justify font-bold mt-6"> Contact
                                    Person Bagian
                                    Grosir: </p>
                                <p class="text-sm text-green-600 leading-relaxed text-justify font-bold "> Admin Trading
                                    (
                                    0877 2651
                                    5174 ) </p>
                            </div>
            ...
            {{-- FOOTER --}}
            <footer class="bg-[#131414] font-sans tracking-wide mt-20">
